          ...
          <table class="table table-sm table-striped table-hover">
            <thead>
              <tr>
                ...
                <th :class="getSortClass('image') + ' d-none d-md-table-cell'">
                  <router-link :to="getLink('sort','image')">Image</router-link>
                </th>
                <th :class="getSortClass('name')">
                  <router-link :to="getLink('sort','name')">Name</router-link>
                </th>
                <th :class="getSortClass('price') + ' d-none d-md-table-cell'">
                  <router-link :to="getLink('sort','price')">Price</router-link>
                </th>
            ...
            <tbody>
              <tr v-for="product in products" :key="product">
                ...
                <td class="d-none d-md-table-cell text-center"><a v-if="product.image" :href="`http://localhost:8080/app/uploads/products/${product.image}`" target="_blank" :title="`${product.image}`"><img class="img-list" :src="`http://localhost:8080/app/uploads/products/${product.image}`" /></a></td>
                <td>{{product.name}}</td>
